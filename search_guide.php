...
<ul class="nav">
  ...
  <li style="float:right"> <a href="firstpage.html"> Sign out </a></li>
</ul>
<br>
<?php
session_start();
...
$results = mysqli_query($connection,"select * from guide where city = '{$city}' ");
...
while($rows = mysqli_fetch_assoc($results)){
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6">
				<img src="imagesguide/<?php echo $image;?>" style="max-width:100%;"/>
			</div>
			<div class="col-lg-6">
				<ul class="bl">
					...
					<li><?php echo "pno    : ".$pno?></li>
				</ul>
			
					<p ><?php echo "About the guide :<br>".$about;?></p>
			</div>
		</div>
	</div>
<?php
